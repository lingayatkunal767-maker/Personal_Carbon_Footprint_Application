  ...
  useEffect(() => {
    const fetchGoalsData = async () => {
      try {
        ...
        setCurrentGoal(res.data.currentGoal);
        ...
        setMilestones([
          { title: 'Reduce by 5%', completed: true, date: 'Jan 10' },
          { title: 'Reduce by 10%', completed: true, date: 'Jan 15' },
          { title: 'Reduce by 15%', completed: false, date: 'Jan 25' },
          { title: 'Reduce by 20%', completed: false, date: 'Jan 31' },
        ]);
        setPastGoals([
          { title: 'Reduce by 10% in December', achieved: true, final: '12% reduction' },
          { title: 'Cycle 50km in November', achieved: true, final: '67km cycled' },
          { title: 'Save 500 kWh in October', achieved: false, final: '420 kWh saved' },
        ]);
      } finally {
        setIsLoading(false);
      }
