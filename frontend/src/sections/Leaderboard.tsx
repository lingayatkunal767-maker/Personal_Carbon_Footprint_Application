  ...
  useEffect(() => {
    const fetchLeaderboardData = async () => {
      try {
        ...
        setLeaderboardData({
          weekly: [
            { rank: 1, name: 'Team Green', score: 845, members: 12, trend: 'up' },
            { rank: 2, name: 'Team Earth', score: 720, members: 8, trend: 'same' },
            { rank: 3, name: 'Team Eco', score: 690, members: 15, trend: 'up' },
            { rank: 4, name: 'Team Sustain', score: 650, members: 10, trend: 'down' },
            { rank: 5, name: 'Team Renew', score: 620, members: 6, trend: 'same' },
            { rank: 6, name: 'Team Leaf', score: 580, members: 9, trend: 'up' },
            { rank: 7, name: 'Team Nature', score: 540, members: 11, trend: 'down' },
          ],
          monthly: [
            { rank: 1, name: 'Team Earth', score: 3240, members: 8, trend: 'up' },
            { rank: 2, name: 'Team Green', score: 2980, members: 12, trend: 'same' },
            { rank: 3, name: 'Team Eco', score: 2750, members: 15, trend: 'up' },
            { rank: 4, name: 'Team Sustain', score: 2600, members: 10, trend: 'up' },
            { rank: 5, name: 'Team Renew', score: 2450, members: 6, trend: 'down' },
          ],
          alltime: [
            { rank: 1, name: 'Team Green', score: 15420, members: 12, trend: 'same' },
            { rank: 2, name: 'Team Earth', score: 14280, members: 8, trend: 'same' },
            { rank: 3, name: 'Team Eco', score: 12890, members: 15, trend: 'up' },
            { rank: 4, name: 'Team Sustain', score: 11500, members: 10, trend: 'same' },
            { rank: 5, name: 'Team Renew', score: 10800, members: 6, trend: 'down' },
          ],
        });
      } finally {
        setIsLoading(false);
